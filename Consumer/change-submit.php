...
session_start();
echo $_POST["deviceidnew"];
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $deviceId = $_POST["deviceidnew"];
    $onof = "";
    $brightness = "";
    $temperature = "";
    $connectionv = "";
    ...
    $sql = "UPDATE devices SET properties_consumer = '$propsJsonEscaped' WHERE id = $deviceId";
    $result = mysqli_query($conn, $sql);
    if ($result) {
    ...
    $sql = "INSERT INTO logs (`id`, `role`, `room_id`, `device_id`, `device_name`, `previous_state`, `new_state`, `request`, `date`) VALUES (NULL, 'consumer', '$roomnameid', '$deviceId', '$deviceName', '$previousState', '$previousState', '$propsJson',
         '$formattedDateTime');";
